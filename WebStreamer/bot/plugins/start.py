...
START_TEXT = """
<i>👋 Hᴇʏ,</i>{}\n
<i>ɪᴀᴍ ᴀ ᴅɪʀᴇᴄᴛ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ ɢᴇɴᴀʀᴀᴛᴏʀ ʙᴏᴛ,ᴍᴀᴅᴇ ʙʏ @Unavailable4allTime♡...ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴅɪʀᴇᴄᴛ ʟɪɴᴋs 𝘧ᴏʀ ᴀʟʟ ᴋɪɴᴅ ᴏ𝘧 𝘧ɪʟᴇ𝘴 ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ...ɪ𝘧 ʏᴏᴜ ʟɪᴋᴇ𝘴 ᴍʏ 𝘴ᴇʀᴠɪᴄᴇ,ʏᴏᴜ ᴄᴀɴ 𝘴ᴜᴘᴘᴏʀᴛ ᴍᴇ ʙʏ ɢɪᴠɪɴɢ 𝘴ᴍᴀʟʟ ᴅᴏɴᴀᴛɪᴏɴ𝘴ʕ•‌-•ʔ</i>\n
<i>ᴜᴘɪ - muhammad.8511@wahdfcbank (ʟᴏɴɢ ᴘʀᴇ𝘴𝘴 ᴛᴏ ᴄᴏᴘʏ)</i>\n
<i><u>𝗪𝗔𝗥𝗡𝗜𝗡𝗚 🚸</u></i>
<b>🔞 Pʀᴏɴ ᴄᴏɴᴛᴇɴᴛꜱ ʟᴇᴀᴅꜱ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʙᴀɴ ʏᴏᴜ.</b>\n\n
<i><b>🍃 Bᴏᴛ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ :</b>@Unavailable4allTime</i>"""
...
<u>🔸 𝗪𝗔𝗥𝗡𝗜𝗡𝗚 🚸</u>\n
<b>🔞 Pʀᴏɴ ᴄᴏɴᴛᴇɴᴛꜱ ʟᴇᴀᴅꜱ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʙᴀɴ ʏᴏᴜ.</b>\n
<i>Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ (ᴏʀ) ʀᴇᴘᴏʀᴛ ʙᴜɢꜱ</i> <b>: <a href='https://t.me/Unavailable4allTime'>[ ᴄʟɪᴄᴋ ʜᴇʀᴇ ]</a></b>"""
    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>Sᴏᴍᴇᴛʜɪɴɢ ᴡʀᴏɴɢ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ</i> <b><a href='http://t.me/Unavailable4allTime'>[ ᴄʟɪᴄᴋ ʜᴇʀᴇ ]</a></b>",
                    parse_mode=ParseMode.HTML,
                    disable_web_page_preview=True)
                return
        await m.reply_text(
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="**Sᴏʀʀʏ Sɪʀ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴍᴇ. Qᴜɪᴄᴋʟʏ ᴄᴏɴᴛᴀᴄᴛ** @Unavailable4allTime",
                        parse_mode=ParseMode.MARKDOWN,
                        disable_web_page_preview=True
                    )
                    return
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** [Aᴠɪsʜᴋᴀʀ Pᴀᴛɪʟ](https://t.me/Unavailable4allTime).",
                    parse_mode=ParseMode.MARKDOWN,
                    disable_web_page_preview=True)
                return
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Owner](https://t.me/Unavailable4allTime).",
                parse_mode=ParseMode.MARKDOWN,
                disable_web_page_preview=True)
            return
